...
*/
Adafruit_StepperMotor *motor1 = AFMS.getStepper(200, 1); // The motor connected to M3 & M4
...
*/
Adafruit_StepperMotor *motor2 = AFMS.getStepper(200, 2); // The motor connected to M1 & M2
